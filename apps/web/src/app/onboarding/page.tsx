...
export default function OnboardingPage() {
  ...
  const completeOnboarding = useStiloStore((s) => s.completeOnboarding);
      ...
      >
        {step === "welcome" && (
          <>
            ...
            <div>
              <h1 className="font-display text-3xl font-bold">Welcome to Stilo</h1>
        ...
        >
          {step === "ready" ? "Open Stilo" : "Continue"}
          <ArrowRight size={18} />
        </button>
      </motion.div>
    </div>
